        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark navSup">
            <div class="container">
                ...
                <div class="navbar-header navbar-right">
                    <!-- <a href="" class="hidden-xs navbar-brand"><img alt="DGPe" style="width: 90px"  src="<?= base_url('/images/engine.ico')?>"></a>    -->
                </div>
            </div>
        </nav>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light navDelgada2 profundidad2">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav mr-auto ">
                    ...
                    <li class="nav-item"> 
                        <a class="nav-link titulo6" href="<?= base_url('/progra')?>" >&nbsp;&nbsp;&nbsp;Inicio </a>  
                    </li>
